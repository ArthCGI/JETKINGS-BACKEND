...
namespace JetKings.Entity;

public partial class JetKingsDbContext : DbContext
{
    public JetKingsDbContext()
    {
    }

    public JetKingsDbContext(DbContextOptions<JetKingsDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=jetkings-db.cqn04q0ie3vi.us-east-1.rds.amazonaws.com,1433;Database=JetKingsDBDev;User Id=admin;Password=administrator;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Buyer>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__buyers__3213E83F63FD6DFB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__buyer_pr__3213E83F5068AF59");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__categori__3213E83F9FE0F5AB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__company__3213E83F81646A0B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__invoices__3213E83F78C76FA4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__invoice___3213E83F8BE1A653");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__products__3213E83F4DFFBB24");
